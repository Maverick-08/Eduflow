                    ...
                    <div className="w-3/4">
                        <div className="bg-white shadow rounded-lg p-4 mb-4">
                            <div className="flex items-center space-x-2">
                                <input type="text" placeholder="Search Material" className="w-full border border-purple-300 rounded-lg p-2" />
                            </div>
                        </div>
                        <div className="bg-white shadow rounded-lg p-4 mb-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="font-medium">Sugandha Gupta posted a new material: 2018 solutions</p>
                        ...
                        <div className="bg-white shadow rounded-lg p-4 mb-4">
                            <div className="flex items-center space-x-2">
                                <i className="fas fa-file-alt text-purple-600"></i>
                                <div>
                                    <p className="font-medium">Sugandha Gupta posted a new material: OBE 2021 solutions</p>
                                    <p className="text-purple-600 text-sm">May 28, 2023</p>
                                </div>
                                <i className="fas fa-ellipsis-v text-purple-600 ml-auto"></i>
                            </div>
                        ...
                        <div className="bg-white shadow rounded-lg p-4 mb-4">
                            <div className="flex items-center space-x-2">
                                <i className="fas fa-file-alt text-purple-600"></i>
                                <div>
                                    <p className="font-medium">Sugandha Gupta posted a new material: Regularization</p>
