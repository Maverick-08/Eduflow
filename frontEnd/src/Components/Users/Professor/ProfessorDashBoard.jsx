        ...
        <main className="flex-1 p-6 bg-gray-100" style={{ minHeight: "100vh" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {courses.map((course, index) => (
                    ...
                    >
                        <div className="p-6 border-b" style={{ backgroundColor: "#f1f5f9" }}>
                            <h2 className="text-lg font-semibold text-blue-800 mb-2">
                                {course.subject_name}
                            </h2>
                            <p className="text-sm text-gray-600">Year: {course.year || "N/A"}</p>
                        </div>
                        <div className="p-6">
                            <p className="text-gray-700 mb-1"><strong>Course:</strong> {course.course[0]}</p>
                            <p className="text-gray-700 mb-1"><strong>Department:</strong> {course.department[0]}</p>
            ...
            <div className={`${isAssignmentVisible ? 'block' : 'hidden'} fixed inset-0 bg-black opacity-30`} onClick={toggleAssignmentForm}></div>
        </main>
    );
}
