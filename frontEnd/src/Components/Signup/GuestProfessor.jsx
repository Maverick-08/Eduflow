...
const GuestProfessor = () => {
    ...
    const [userType, setUserType] = useState('guestProfessor');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let response = await axios.post(`${backEndLink}/signup`, {
                email, password, fname, lastname, gender, mobile, userType, department, course // Added new fields
        ...
        console.log({ email, password, fname, lastname, gender, mobile, userType, department, course });
    };
    ...
    return (
        <div className="flex items-center p-8 justify-center bg-gray-100">
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md w-96">
                ...
                {/* New fields for Department and Course */}
                <div className="mb-4">
