    ...
    try {
      ...
      let response = await axios.post(
        `${backEndLink}/register`,
        {
          ...
          department: newArra,
          user_type,
          experience_level, // Added user_type
        },
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            required
            className="mt-1 block w-full p-2 border border-gray-300 rounded focus:ring focus:ring-blue-600 focus:outline-none"
          />
        </div>
